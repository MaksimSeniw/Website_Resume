...
const setEducation = education => {
  ...
  education.forEach(edu => {
    ...
    //
    const eduMinor = document.createElement('span');
    eduMinor.className = 'edu-std';
    eduMinor.innerHTML = edu.minor;
    eduClassData.appendChild(eduMinor);

    li.appendChild(eduClassData);

    li.appendChild(eduMinor);
